...
# 1️⃣ Створюємо таблицю (якщо її ще нема)
db.create_table()

# 2️⃣ Додаємо всі товари
products_list = [
    {
    ...
    },
    {
        "name": "Жіночий жилет",
        "price": 1220,
        "description": "Практична, зручна жилетка вкороченого крою буде чудово поєднуватися з будь-яким одягом і захищати від холоду за рахунок утеплювача та високого коміра.",
        "size": "L",
        "color": "сірий",
        "category": "Одяг",
        "stock": 30,
...
print("База заповнена всіма товарами ✅")
